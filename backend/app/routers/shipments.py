...
@router.get("/alerts/delayed", response_model=list[ShipmentAlert])
...
@router.get("/history", response_model=list[ShipmentRead])
def get_shipment_history(
    ...
    """Fetch shipment history filtered by customer name or vehicle ID."""
...
async def create_shipment_endpoint(
    ...
    """Create a new shipment. Restricted strictly to Admin."""
    ...
    return shipment_crud.create_shipment(db, shipment_in)
...
async def update_shipment_endpoint(
    ...
    """Update shipment details, reassign vehicle/driver. Restricted strictly to Admin."""
...
def update_status_endpoint(
    ...
    """Delivery status progression endpoint: Created -> Assigned -> In Transit -> Delivered. Restricted strictly to Admin."""
...
def cancel_shipment_endpoint(
    ...
    """Cancel shipment. Restricted strictly to Admin."""
